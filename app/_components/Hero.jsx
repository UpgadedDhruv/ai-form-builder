...
<section >
  <div className="mx-auto max-h-screen px-4 py-56 bg-white ">
    <div className="mx-auto max-w-lg text-center">
      <h2 className="text-3xl font-bold sm:text-4xl">How it Works</h2>

      <p className="mt-4 text-gray-400">
      AI-Powered Dynamic Form Builder that simplifies form creation using AI-driven field generation and customization.
    ...
    <div className="  mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
       <AtomIcon className='h-8 w-8'/>
        ...
        <p className="mt-1 text-sm text-gray-600">
          write a description of the form you want!
        </p>
      </a>
      ...
      <Edit className='h-8 w-8'/>
        ...
        <p className="mt-1 text-sm text-gray-600">
          Did a mistake? No worries, here you can modify your form 
        </p>
      </a>
      ...
      <Share2 className='h-8 w-8' />
        ...
        <p className="mt-1 text-sm text-gray-600">
         Share the form with target group to collect information.
        </p>
      </a>
    ...
    <div className="mt-12 text-center">
      <a
        href="/sign-in"
        className="inline-block rounded bg-primary px-12 py-3 text-sm font-medium text-white transition hover:bg-purple-600 focus:outline-none focus:ring focus:ring-yellow-400"
      >
        Get Started Today
      </a>
    </div>
